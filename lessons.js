const LESSONS_DATA = {
  ...
  8: {
    ...
    emoji: "🥑",
    sentences: [
      "A few days after the market, I texted Sarah to meet up at one of my favorite local spots.",
      "Hi Sarah! How’s your trip going?",
      "Do you have time for a coffee today?",
      "I’d love to take you to a place called 'Trình'.",
      "Hi Rose! That sounds great!",
      "I’ve heard about that place.",
      "What’s the specialty there?",
      "You have to try their Avocado Coffee.",
      "It sounds a bit strange, but it’s delicious!",
      "See you at 3 PM?",
      "The cafe was green and peaceful.",
      "We walked to the counter to order.",
      "I’m so glad you could make it!",
      "Here, let’s order first.",
      "In Vietnam, we love mixing coffee with fruit, and avocado is a local favorite.",
      "Avocado Coffee?",
      "Back in New Zealand, we only have avocado on toast!",
      "I’m curious.",
      "How do I order it?",
      "It’s easy.",
      "Just say: 'Cho tôi một cà phê bơ.'",
      "Let me try...",
      "Cho tôi... một... cà phê bơ.",
      "Did I get the tones right?",
      "Perfect!",
      "You sound like a local.",
      "Now, let's get our drinks.",
      "Wow, this is incredible!",
      "It’s so creamy and rich.",
      "The bitterness of the coffee goes so well with the avocado.",
      "It’s like a dessert!",
      "Haha, I told you!",
      "It’s a real treat.",
      "In Vietnam, 'đi cà phê' isn't just about the caffeine; it’s about slow living.",
      "We can sit for hours, just chatting and enjoying the vibe.",
      "I love that.",
      "It’s so relaxing.",
      "By the way, I’d love to buy some coffee beans like this to take home as gifts.",
      "Do you know where I can get some good ones?",
      "Actually, you're in luck!",
      "They sell their own roasted beans right here at the counter.",
      "The packaging is beautiful, too.",
      "We can pick some up before we leave.",
      "But for now, let’s just enjoy this view.",
      "Oh, perfect!",
      "That saves so much time.",
      "Good idea.",
      "Oh, and how do we ask for the bill here?",
      "You can just catch the waiter's eye and say: 'Tính tiền cho mình với.'",
      "Or simply: 'Thanh toán nhé.'",
      "'Thanh... toán... nhé.'",
      "Got it!",
  ...
  9: {
    ...
    emoji: "🏮",
    sentences: [
      "After our coffee at Trình, Sarah mentioned her family was heading to Hoi An for the weekend.",
      "She had already booked a place called Homestay Ồ! online, but she wanted some local advice on how to truly enjoy the slow life there.",
      "Rose, I’ve booked Homestay Ồ! for the weekend.",
      ...
      "What about the Coconut Forest?",
      "I heard it’s very touristy.",
      "It can be.",
      "My tip is: don't go in the afternoon when the big tour groups arrive.",
      "Go early in the morning or just before sunset.",
      "It's much quieter.",
      "You can just enjoy the sound of the water.",
      "That’s exactly what we need.",
      "And what about the Thanh Ha Pottery Village?",
      "Is it worth a visit?",
      "Definitely!",
      "But instead of just looking, you should sit down and try making a small clay whistle or a bowl.",
      "It’s very meditative.",
      "Just ask them: 'Can I try?'",
      "I’ll do that!",
      "Oh, and one more thing—we want to try some authentic food, not just the tourist menus.",
      "Then you have to try 'Cơm Gà' (Chicken Rice) or 'Cao Lầu' in the local market.",
      "Don't be afraid of the small plastic stools!",
      "If you’re not sure about the price, you can still use: 'Bao nhiêu tiền?'",
      "Haha, I’m getting used to that question now!",
      "Thanks, Rose.",
      "I really appreciate the local perspective.",
      "My pleasure!",
      "Hoi An is about the small details.",
      "Just slow down and take it all in.",
      "I was glad I could give Sarah some \"insider\" advice.",
...
10: {
    ...
    emoji: "🚗",
    sentences: [
      "A few days after Sarah got back from Hoi An, we caught up again.",
      "She was so thrilled about the pottery village that she was eager to see more of Central Vietnam.",
      "Her next stop was Hue, the ancient capital.",
      "Rose, Hoi An was such a blast!",
      "The kids are still playing with those clay whistles.",
      "Now, we're planning to head out to Hue.",
      "What’s the best way to get there?",
      "I'm so glad to hear that!",
      "You’ve got a few options: the train, a private car, or even a sleeper bus.",
      "But since you’re traveling with the family and want to catch the views, I’d stick with a car or the train.",
      "I’ve heard the mountain pass is stunning.",
      "Is it doable by motorbike?",
      "Actually, a lot of travelers love doing that!",
      "It’s the best way to feel the breeze and see the Hai Van Pass up close.",
      "But with the kids, you might want to look into a motorbike tour with professional drivers.",
      "We call them 'Easy Riders'.",
      "That sounds like quite an adventure!",
      "But we'll probably just stick with a car this time so the kids can nap.",
      "How do I ask the driver to pull over for a photo?",
      "Just tell him: 'Could you pull over here for a second?'",
      "They’re very used to it.",
      "But just a heads-up, the road is pretty windy.",
      "Do you get motion sickness?",
      "A little bit, but for that view, it’s totally worth it!",
      "Could you pull over here...?",
      "Got it!",
      "Great!",
      "It’s a gorgeous drive.",
      "You’ll pass by Bach Ma National Park and Lang Co Bay too.",
      "You're going to love the royal vibe in Hue.",
      "Helping Sarah plan her trip made me realize that travel isn't just about the destination.",
      "It’s about the beauty we find along the way.",
      "Sometimes, the journey itself is the best gift of all."
    ]
  }
};
